...
function Project2() {
  return (
    <div >
      ...
      <div className='prjt_bg_txt'>
          <h1><b>Projects</b></h1> <br />
          <p style={{fontSize:'20px'}}>Some of my most recent works</p>
      </div>

      <div className='project_details'>
        <div>
          <h2 className='capstone_tittle'><b>Capstone Projects</b></h2>
        </div>

       <div className='capstone_projects'>
       <CardComponent/>
       <CardComponent2/>
       </div>

       <div>
          <h2 className='capstone_tittle'><b>Mini Projects</b></h2>
        </div>
